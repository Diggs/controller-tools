...
import (
	...
	testloader "github.com/Diggs/controller-tools/pkg/loader/testutils"
)
...
var _ = BeforeSuite(func() {
	modules := []pkgstest.Module{
		{
			Name: "github.com/Diggs/controller-tools/pkg/markers/testdata",
	...
	var err error
	pkgs, exported, err = testloader.LoadFakeRoots(pkgstest.Modules, modules, "github.com/Diggs/controller-tools/pkg/markers/testdata")
